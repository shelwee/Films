    ...
    <div class="header">
    	...
    	<div class="header_2">
			...
			<form id="searchForm" action="<%=path %>/search.do?flag=search" method="post">
				...
				<span>热搜：</span>
			<a class="key_word" onClick="gotoSearch(this)" href="javascript:void(0)" title="倾城">倾城</a><a class="key_word" onClick="gotoSearch(this)" href="javascript:void(0)" title="遗落战境">遗落战境</a><a class="key_word" onClick="gotoSearch(this)" href="javascript:void(0)" title="天机．富春山居图">天机．富春山居图</a></form>
		</div>
    		</div>
    	</div>
    	<div class="menu">
